...
TOKEN_TYPES = [
    ...
    TokenType('DO', f'(D|d)(O|o)'),
    TokenType('TO', f'(T|t)(O|o)'),
    TokenType('WRITE', f'(W|w)(R|r)(I|i)(T|t)(E|e)'),
    TokenType('WRITELN', f'(W|w)(R|r)(I|i)(T|t)(E|e)(L|l)(N|n)'),
    TokenType('FOR', f'(F|f)(O|o)(R|r)'),
